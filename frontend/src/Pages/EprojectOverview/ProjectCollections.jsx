...
const goback=(e)=>{
  ...
  if(dirty){
    ...
    if (result == true) {
      e.preventDefault();
      navigate('/single-project-details',{state:{id:project_id,mainid:main_id,varreturn:false,scrollpage:'1'}});
    }
    else{
    ...
    e.preventDefault();
    navigate('/single-project-details',{state:{id:project_id,mainid:main_id,payreturn:false,varreturn:false,scrollpage:'1'}});
  }
...
const updateProjectLog=(e)=>{
    ...
    axios.post(AppURL.UpdateProjectEvents,data,{
      ...
      const ProjectDetails = async()=>{
        try{
          const invoices = await axios.get(AppURL.GetProjectCollection(main_id))
    ...
    >
      <Modal size="xl" show={show} fullscreen={fullscreen}>
        <Modal.Header >
          ...
          <Row className=''>
                      <Col md="12">
                       <h3 className=''>Project Collections</h3>
                       </Col>
