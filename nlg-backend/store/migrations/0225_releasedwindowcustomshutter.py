# Generated by Django 4.1.1 on 2024-01-05 10:16
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('store', '0224_deliverynotefromsupplierglass'),
    ]

    operations = [
        migrations.CreateModel(
            name='ReleasedWindowCustomShutter',
            fields=[
                ...
                ('ReleasedWindowCS', models.ForeignKey(default='1', on_delete=django.db.models.deletion.CASCADE, related_name='ReleasedWindowCS', to='store.releasedwindow')),
            ],
        ),
    ]
